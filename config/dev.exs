...
config :chatter, ChatterWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "kZPbKMiTyX6vtaQnWU9S3Cmbn4onlbU4DHU6w/n3Zd6uwGixm03sSF5ud9YV3FdG",
  watchers: [
...
config :chatter, ChatterWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/chatter_web/router\.ex$"E,
      ~r"lib/chatter_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
